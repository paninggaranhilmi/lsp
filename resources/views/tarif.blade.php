            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('edittarif', $item->id) }}"><button class="btn btn-success">Update</button></a>
                    <a href="{{ route('deletetarif', $item->id) }}"><button class="btn btn-danger">Delete</button></a>
                  </td>
                </tr>
                @endforeach
              </tbody>
